<?php function rl_split() {	global $PHP_SELF, $list, $options; ?>
...
<?php if (function_exists('hash_file')) echo '<input type="radio" name="crc_mode['.$i.']" value="hash_file" checked="checked" />&nbsp;'.lang(172).'<br />'; ?>
